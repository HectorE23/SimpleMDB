...
public class MockActorService : IActorService
{
    ...
    {
        return new Result<Actor>(new Exception("First name cannot have more than 16 character"));
    }
    ...
    {
        return new Result<Actor>(new Exception("Last name cannot have more than 16 character"));
    }
