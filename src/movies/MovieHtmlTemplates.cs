    ...
    foreach (var movie in movies)
    {
        rows += @$"
            <tr>
                ...
                <td><a href=""/movies/actors/view?mid={movie.Id}"">Actors</a></td>
                <td>
...
<form class=""addform"" action=""/movies/add"" method=""POST"">
   ...
   <label for=""year"">Year</label>
        <input id=""year"" name=""year"" type=""number"" min=""1888"" max=""{DateTime.Now.Year}"" placeholder=""Year"" value=""{year}"">
...
";
    ...
    <form class=""editform"" action=""/movies/edit?mid={mid}"" method=""POST"">
        ...
        <label for=""year"">Year</label>
        <input id=""year"" name=""year"" type=""number"" min=""1888"" max=""{DateTime.Now.Year}"" placeholder=""Year"" value=""{movie.Year}"">
        <label for=""description"">Description</label>
